...
def auto_corr(ts, max_lag = 200, title = '', double_conf = False, first = True, plot = True, preset_counts = None, double_count = 1):   
    ...
    if plot:
      ...
      plt.plot(lags,confidence_interval, color = 'red', label = r'2$\sigma$ confidance interval')
      if double_conf:
...
def plot_gen_vs_benchmark(data_gen, data_real, ACF, ACF_err, ACF_nonabs, ACF_nonabs_err, leverage, leverage_err, ts, max_lag, ylim_ACF = [0,0.35], ylim_ACF_nonabs = [-0.1,0.1], ylim_lev = [-0.11, 0.05], double_count = 1):
    ...
    axs[1,0].plot(lags, CI, color = 'red', label = r'2$\sigma$ confidance interval')
    ...
    axs[1,1].plot(lags, CI, color = 'red', label = r'2$\sigma$ confidance interval')
    ...
    axs[2,0].plot(lags, CI, color = 'red', label = r'2$\sigma$ confidance interval')
    ...
    axs[2,1].plot(lags, CI, color = 'red', label = r'2$\sigma$ confidance interval')
    ...
    axs[3,0].plot(lags, leverage_bench)
